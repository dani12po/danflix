        ...
        <section className="hero-section">
          ...
          <div className="hero-content">
            <motion.h1 
              ...
              className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent leading-none"
            >
              StreamFlix
            </motion.h1>
            <motion.p 
